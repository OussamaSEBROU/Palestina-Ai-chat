The Palestine AI Info Bot is a web-based application built using Streamlit and powered by Google's Gemini AI to provide users with comprehensive, accurate, and context-aware information about Palestine. This app serves as an interactive assistant that answers questions related to Palestine's history, current events, humanitarian issues, political context, and geopolitical relations.
